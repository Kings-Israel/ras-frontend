        ...
        <div class="basis-3/4">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <x-primary-outline-button class="h-5 font-extralight tracking-tighter px-20 py-4 bg-orange-400 border border-orange-400 text-white rounded-3xl hover:bg-orange-800 hover:border-orange-800">Make Inquiry</x-primary-outline-button>
                    <x-primary-outline-button class="h-5 font-extralight tracking-tighter px-20 py-4 text-orange-400 rounded-3xl">Chat</x-primary-outline-button>
                </div>
            </div>
            <div class="mt-10">
