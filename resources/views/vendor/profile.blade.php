    ...
    <div class="p-3 sm:ml-64 lg:grid lg:grid-cols-4 lg:divide-x">
        <div class="p-3 md:col-span-3">
            ...
            <div class="flex flex-row gap-2 w-[90%] mx-auto -mt-24 profile-form relative">
                <div class="basis-1/4 border-2 border-gray-300 rounded-lg py-6 divide-y-2 bg-white h-[20%]">
                ...
                <div class="basis-3/4 border-2 border-gray-300 rounded-lg bg-white py-4 px-4 divide-y-4">
                    <div class="flex gap-6">
                        <span class="font-extrabold text-orange-400 underline underline-offset-2 decoration-4">Account Settings</span>
