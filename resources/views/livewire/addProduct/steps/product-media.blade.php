<div>
    ...
    <div class="flex justify-end gap-2 mt-4">
        <x-secondary-outline-button class="text-center text-gray-800 gap-2" wire:click="previousStep"><i class="fas fa-arrow-left text-gray-800"></i> Back</x-secondary-outline-button>
