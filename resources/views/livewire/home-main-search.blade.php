    ...
    <form class="">
        <div class="flex">
            ...
            <div class="relative w-full">
                ...
                >
                @if (strlen($search) >= 1)
                    <div class="bg-gray-300 p-2 rounded-lg w-full z-40 absolute" x-show="isOpen" x-transition.duration.300ms>
                        @if (count($results) > 0)
