            ...
            <div class="lg:grid lg:grid-cols-3 h-full" id="messages-container">
                ...
                <div class="lg:col-span-2 border-none hidden lg:block" id="messages-box" v-if="conversation_log.length > 0" ref="messagesBox">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="pb-2 lg:fixed lg:bottom-6 w-[94%] lg:w-[40%] 4xl:w-[42%]">
                            <form action="#" method="POST" class="mx-3 lg:my-2 w-full flex gap-1">
                                ...
                                <i class="fas fa-paperclip text-gray-400 text-xl my-auto lg:mr-2 w-[5%]"></i>
