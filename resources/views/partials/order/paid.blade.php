                    ...
                    <tr class="bg-gray-100 border-2 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 hover:cursor-pointer">
                        <td colspan="10">
                            <ol class="flex justify-between items-center ml-5 mr-5 w-[96%]">
                                ...
                                <li>
                                    <span class="text-gray-400 font-bold -ml-4">Inspection</span>
                                </li>
                                <li>
                                    <span class="text-gray-400 font-bold ml-2">Shipping</span>
                                </li>
                                <li>
                                            ...
                                            @if ($accepted_request->importInstruction)
                                                <div class="grid grid-cols-2 space-y-2">
                                                    ...
                                                    <div class="col-span-2">
                                                        ...
                                                        <div class="flex gap-2">
                                                            @foreach ($accepted_request->importInstruction->documents_attached as $key => $document)
                                                                <a href="{{ config('app.admin_url').'/storage/reports/logistics/'.$document }}" target="_blank">
                                                                    <x-primary-button class="py-1">{{ $key }}</x-primary-button>
                                                                </a>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="space-y-2 p-2 lg:px-4">
                                            @if ($accepted_request->exportInstruction)
                                                <div class="grid grid-cols-2 space-y-2">
                                                    <div class="flex gap-2">
                                                        <span class="">Shipper/Exporter:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->exporter }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Reference:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->reference }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">VAT Number:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->vat_number }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Consignee:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->consignee }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Notify Party:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->notify_party }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Place of Collection:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->place_of_collection }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Port of Loading:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->port_of_loading }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Port of discharge:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->port_of_discharge }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Final Destination:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->final_destination }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Destination Country:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->destination_country }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Methods of Payment:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->method_of_payment }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Mode of Transport:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->mode_of_transport }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Type of Freight:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->type_of_freight }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Number of Packages:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->number_of_packages }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Type of Packages:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->type_of_packages }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Marks and Numbers:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->marks_and_numbers }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Description of goods:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->description_of_goods }}</span>
                                                    </div>
                                                    <div class="flex gap-2 flex-wrap col-span-2">
                                                        <span class="">Special goods/hazardous, perishable or taint:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->special_goods }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Gross Mass in kgs:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->gross_mass }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Measurement:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->measurement }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Cargo Insurance:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->cargo_insurance }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Cargo Value:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->cargo_value }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Incoterms:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->incoterms }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">C.I Value:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->ci_value }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Customs Export Purpose Code:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->customs_export_purpose_code }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Customs Export Number:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->customs_export_number }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Tariff heading:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->tariff_heading }}</span>
                                                    </div>
                                                    <div class="flex gap-2">
                                                        <span class="">Special Instructions:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->special_instructions }}</span>
                                                    </div>
                                                    <div class="flex gap-2 flex-wrap">
                                                        <span class="">Other:</span>
                                                        <span class="font-semibold">{{ $accepted_request->exportInstruction->other }}</span>
                                                    </div>
                                                    <div class="col-span-2">
                                                        <span class="font-semibold">Documents:</span>
                                                        <div class="flex gap-2">
                                                            @foreach ($accepted_request->exportInstruction->documents_attached as $key => $document)
                                                                <a href="{{ config('app.admin_url').'/storage/reports/logistics/'.$document }}" target="_blank">
                                                                    <x-primary-button class="py-1">{{ $key }}</x-primary-button>
                                                                </a>
                                                            @endforeach
